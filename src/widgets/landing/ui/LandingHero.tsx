      ...
      <div className="flex w-full flex-col pt-20 lg:flex-row lg:items-center lg:justify-between lg:pt-0">
        <div className="relative z-10 ml-10 flex w-full flex-col items-start text-left md:px-10 lg:ml-26 lg:w-90 lg:gap-80 lg:px-0 xl:w-100">
          <div className="relative flex flex-col items-start text-left">
            ...
            <span className="text-md relative z-10 mb-1 font-medium text-slate-400 md:text-base lg:text-xl">
              함께 완성해 가는 워크스페이스
            </span>
            <h1 className="text-brand-primary relative z-10 mb-8 text-[28px] font-bold md:text-[36px] lg:mb-28 lg:text-5xl">
              Coworkers
            </h1>
          </div>
